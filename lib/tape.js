const DATA_MAX_SIZE = 49152;
const TAPE_SIZE = DATA_MAX_SIZE + 115;
...
class Tape {
    ...
    getAvailable() {
        return DATA_MAX_SIZE - this.pointer;
    }

    getBuffer() {
        const buf = Buffer.alloc(this.pointer);
        this.tape.copy(buf, 0, 0, this.pointer);
        return buf;
    }
}
